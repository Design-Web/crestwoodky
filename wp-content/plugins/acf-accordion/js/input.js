		...
		acf.add_action('ready append', function( $el ){
            ...
            (function ($) {
                jQuery(".acf-tab-button").click(function () {
                    ...
                    jQuery(".acf-field-accordion").nextUntil(".field_type-tab, .acf-field-tab, .acf-field-accordion, script").css("display", "none");
                });
                jQuery(".acf-field-accordion").nextUntil(".field_type-tab, .acf-field-tab, .acf-field-accordion, script").css("display", "none");
                jQuery(".acf-field-accordion").click(function () {
                    ...
                    if ($(this).hasClass("active")) {
                        ...
                        jQuery('.acf-field-accordion').removeClass('active')
                        jQuery(this).addClass('active').nextUntil(".field_type-tab, .acf-field-tab, .acf-field-accordion, script").css("display", "block");
                    }
                });
            })(jQuery);
            //]]>
